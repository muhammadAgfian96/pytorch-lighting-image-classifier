...
import random
import pytest
from src.data_controller.sub_clearml_ds import __regex_input, __query_dataset_id
...
@pytest.mark.parametrize(
    ...
    [
        ('f580a16f0d8e466d9ec79d12d15e071d|[-*:all, overripe:all]', 'f580a16f0d8e466d9ec79d12d15e071d', ['-*:all', 'overripe:all']),
...
@pytest.mark.parametrize(
    ...
    [
        (
            ['-*:all', 'class2:all'], d_urls_by_cat_test,
            {
        ...
        (
            ['*:all', 'class2:10', '-class1:6'], d_urls_by_cat_test,
            {
